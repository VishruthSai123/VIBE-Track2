...
interface CreateIssueModalProps {
  onClose: () => void;
  defaultSprintId?: string | null; // Added optional prop
}

export const CreateIssueModal: React.FC<CreateIssueModalProps> = ({ onClose, defaultSprintId }) => {
  ...
  // Initialize with defaultSprintId if provided
